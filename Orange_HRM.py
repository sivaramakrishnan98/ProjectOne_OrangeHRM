...
class Project_of_HRM():
    def testcase1(self):
        ...
        print("Output will be successfully")
    ...
    def testcase3(self):
        ...
        driver.find_element(By.XPATH,edit_nick_name).send_keys("SRK")
        time.sleep(3)
        ...
        driver.find_element(By.XPATH,edir_employe_employee_id_name).send_keys('26532')

        # entering Other Id
        driver.implicitly_wait(3)
        edir_employe_other_name = "/html/body/div/div[1]/div[2]/div[2]/div/div/div/div[2]/div[1]/form/div[2]/div[1]/div[2]/div/div[2]/input"
        driver.find_element(By.XPATH,edir_employe_other_name).send_keys("Krishan")
        driver.implicitly_wait(3)
        ...
        driver.find_element(By.XPATH,edir_employe_driver_name).send_keys("TN 63537192836")
        driver.implicitly_wait(3)
        
        # select the License Expiry Date
        cal_for_select = '//label[text()="License Expiry Date"]/following::div[3]/input'
        driver.find_element(By.XPATH,cal_for_select).send_keys("2022-12-30")
        time.sleep(4)

        #entering the SSN Number
        SSN_number = '//label[text()="SSN Number"]/following::div[1]/input'
        driver.find_element(By.XPATH,SSN_number).send_keys("234584776")
        time.sleep(3)

        SSN_number1 = '//label[text()="SSN Number"]/following::div[5]/input'
        driver.find_element(By.XPATH,SSN_number1).send_keys("234584776")
        time.sleep(3)
        ...
        print("successfully add the Employee detail")

        driver.quit()

    def testcase4(self):    # If This Testcase get error mean please re-run it again this testcase only
        driver = webdriver.Chrome()
        ...
        clcik_on = driver.find_element(By.XPATH,employe_select).send_keys("siva rama krishnan")
        driver.implicitly_wait(2)
        ...
        print("successfully edit the Employee detail")
    ...
    def testcase5(self):
        ...
        clcik_on = driver.find_element(By.XPATH,emlpoee).send_keys("Siva rama krishnan")
        driver.implicitly_wait(2)
        ...
        time.sleep(10)
        print("Deleted the Employee information")
        driver.quit()
...
Sivaramakrishnan = Project_of_HRM()
Sivaramakrishnan.testcase1()
Sivaramakrishnan.testcase2()
Sivaramakrishnan.testcase3()
Sivaramakrishnan.testcase4()
Sivaramakrishnan.testcase5()